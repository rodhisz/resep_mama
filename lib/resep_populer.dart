  ...
  Widget build(BuildContext context) {
    return CarouselSlider.builder(
      options: CarouselOptions(
          ...
          disableCenter: true,
          autoPlay: true),
      itemCount: ListItemResepPopuler.length,
      itemBuilder: (context, index, pageViewIndex) {
        final ItemResep resepPopuler = ListItemResepPopuler[index];
        return InkWell(
          onTap: () {
            Navigator.push(context, MaterialPageRoute(builder: (context) {
              return DetailCarousel(resep: resepPopuler,);
            }));
          },
          child: Stack(
            children: [
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                Text(resepPopuler.durasi + ' Menit',
                                    style: TextStyle(
                                        fontSize: 12,
                                        fontFamily: 'Poppins',
